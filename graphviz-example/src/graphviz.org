...
Last Modified : 2015 Oct 23 (Fri) 16:20:29 by Harold Carr.
...
#+INCLUDE: "./graphviz.hs.org::*setup" :only-contents t
...
#+INCLUDE: "./graphviz.hs.org::*ex1" :only-contents t

along with some color helper functions:

#+INCLUDE: "./graphviz.hs.org::*helper" :only-contents t
...
#+INCLUDE: "./graphviz.hs.org::*ex3" :only-contents t
...
#+INCLUDE: "./graphviz.hs" :lines "97-119" src haskell
...
#+INCLUDE: "./graphviz.hs.org::*dry" :only-contents t
...
#+INCLUDE: "./graphviz.hs.org::*main " :only-contents t
