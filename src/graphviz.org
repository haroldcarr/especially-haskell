...
Last Modified : 2015 Oct 23 (Fri) 15:10:59 by Harold Carr.
...
#+INCLUDE: "./graphviz.hs" :lines "1-12" src haskell
...
#+INCLUDE: "./graphviz.hs" :lines "14-35" src haskell

along with some color helper functions:

#+INCLUDE: "./graphviz.hs" :lines "37-46" src haskell
...
#+INCLUDE: "./graphviz.hs" :lines "48-95" src haskell
...
#+INCLUDE: "./graphviz.hs" :lines "121-146" src haskell
...
#+INCLUDE: "./graphviz.hs" :lines "148-154"src haskell
